...
import pom.infy.test.domain.Customer;
import pom.infy.test.service.CustomerService;
...
private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(CustomerResource.class);
...
public String ping() {
    ...
    private static final String ENTITY_NAME = "meteringsvcCustomer";

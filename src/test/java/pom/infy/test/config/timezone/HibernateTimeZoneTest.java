package pom.infy.test.config.timezone;

import pom.infy.test.MeteringsvcApp;
import pom.infy.test.repository.timezone.DateTimeWrapper;
import pom.infy.test.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = MeteringsvcApp.class)
